...
I need you to add a landing page to my GitHub repository. Follow these exact steps:
...
4. Use the complete HTML code I'm providing in the attached TASK-1-ADD-LANDING.md file
...
@media (max-width: 768px) { .main-logo { max-width: 280px; } }
```
