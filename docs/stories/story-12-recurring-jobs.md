...
- Add recurring job support to `jobs` table (e.g., recurrence_rule PB format or
  cron-like fields).
...
- API allows creation of a recurring job and generated instances appear in crew
  job lists and owner dashboard.
