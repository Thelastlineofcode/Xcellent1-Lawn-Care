...
- ⭐ 4.8+ Google rating
- 💰 30% profit margin
- 👷 2-3 crew members hired
- 🤖 80% of customer interactions automated
...
2. ✅ **AI Chat Support (24/7)**
   - LangChain + Perplexity integration
   - FAQ handling
   - Lead capture
...
- Epic 5: Stories 5.1, 5.2, 5.3 (Crew login, Job list, Photo upload)
...
4. ✅ **Recurring Service Automation**
   - Auto-schedule weekly/monthly jobs
