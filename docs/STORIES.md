...
This document contains all 90+ user stories across 9 epics for the Xcellent1
Lawn Care SaaS platform.
...
- [x] Simple form: address, lawn size (sqft or lot size), service type (owner
      dashboard only)
