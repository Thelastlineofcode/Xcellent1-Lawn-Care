...
This table maps Functional Requirements (FR-###) to the Epics and Story IDs in `docs/epics.md` and `docs/STORIES.md`.
...
Notes:
- The Story IDs above match how the `docs/epics.md` file lists stories inside each epic. If story ID naming changes or becomes canonical, update this matrix accordingly.
- FR-003 maps to multiple epics (Crew Mobile and Scheduling) because job management spans both areas.
