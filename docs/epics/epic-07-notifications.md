...
Summary
-------
Implement notification and communication channels: emails, SMS, in-app notifications, and debug-friendly agent outbox for sending notifications on events like job creation, completions, and invoices.
