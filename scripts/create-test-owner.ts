...
if (!createUserResponse.ok) {
    ...
    if (authUser.msg?.includes("already registered") || authUser.message?.includes("already registered")) {
        ...
        const existingUser = users.users?.find((u: any) => u.email === "test@xcellent1.com");
