...
- Intake Specialist — `intake-specialist.md`
...
1. Review each JD and adjust pay/benefits to local market.
2. Create job postings on desired platforms (Indeed, LinkedIn, local groups).
3. Use interview checklists included below for screening.
