# Job Description: Billing & Payments Specialist
...
- Collection rate (percent collected within 30 days)

## Interview checklist

1. Describe a time you reconciled a payment discrepancy.
2. Explain how you'd implement a paylink workflow and handle webhook failures.
3. How do you prioritize collections outreach when resources are limited?

## Onboarding (first 2 weeks)

1. Get access to Stripe test account and Supabase billing views.
2. Run a test end-to-end invoice → paylink → webhook flow in staging.
3. Learn escalation paths for disputes and chargebacks.
