# Job Description: Customer Intake Specialist
...
- Comfortable using web-based CRMs or spreadsheets (Supabase/Sheets).
- Attention to detail and ability to follow scripts.
- 1+ year in customer service, dispatch, or related role preferred.

## KPIs

- Lead response time (target <15 minutes during business hours)
- Lead conversion rate
- Data completeness rate (required fields filled)
- Escalation accuracy (correctly marked "needs_pricing_review")
...
1. Access Supabase demo and practice entering test leads.
2. Learn the intake script and pricing heuristics cheat-sheet.
3. Shadow live intake for 3 shifts and process leads with a supervisor.
