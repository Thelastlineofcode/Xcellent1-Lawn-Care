...
The BMAD Framework has been successfully integrated into Claude Code globally. You can now use it anywhere!
...
**How to Use**:
Currently, Claude Code skills are being developed. The framework context is available through slash commands and project config.
...
This activates BMAD mode in any Claude Code conversation. Use it when starting work on event-driven features.
...
**Auto-Activation**:
When working in this project, Claude Code will automatically understand the BMAD framework patterns.
...
Just start working! The `.claude/` configuration will automatically apply BMAD patterns.
...
The `/bmad` command is now available in `~/.claude/commands/bmad.md`. Claude Code will recognize it.
...
The BMAD Framework is now globally integrated with Claude Code. Every conversation, every project - BMAD patterns are available at your fingertips.
